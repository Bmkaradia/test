...
//	$.vegas('slideshow', {
//	  backgrounds:[
//		{ src:'images/slide_img1.png', fade:1000, delay: 9000 },
...
$(document).ready(function() {
 ...
 var rel;
      jQuery(".subbscribe").click(function()
		{
            postion = jQuery("#subbscribe").offset();
			jQuery('body,html').animate({scrollTop: postion.top},'slow');
